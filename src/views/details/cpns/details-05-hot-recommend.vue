...
const{commentModule} = storeToRefs(useDetailStore()) 
...
<template>
  <div class="hot-recommend">
    <detail-section header="热门评论" :footer="`查看全部${commentModule?.totalCount}条评论`">
          ...
          <div class="header">
            <div class="left">
              ...
              <div class="info">
                ...
                <div class="star">
                  <van-rate :model-value="commentModule?.overall" color="#ff9645" size="12" readonly allow-half />
                </div>
              </div>
            </div>
            <div class="right">
              <template v-for="(item, index) in commentModule?.subScores" :key="item">
